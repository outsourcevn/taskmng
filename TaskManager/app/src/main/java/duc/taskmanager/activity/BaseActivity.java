...
//        systemUiVisibility(this);
        String[] itemsTopic = new String[11];
        itemsTopic[0] = getResources().getString(R.string.head_work);
        itemsTopic[1] = getResources().getString(R.string.labour_work);
        itemsTopic[2] = getResources().getString(R.string.study);
        itemsTopic[3] = getResources().getString(R.string.computer);
        itemsTopic[4] = getResources().getString(R.string.book);
        itemsTopic[5] = getResources().getString(R.string.cooperation);
        itemsTopic[6] = getResources().getString(R.string.game);
        itemsTopic[7] = getResources().getString(R.string.shoping);
        itemsTopic[8] = getResources().getString(R.string.junket);
        itemsTopic[9] = getResources().getString(R.string.sport);
        itemsTopic[10] = getResources().getString(R.string.other);
