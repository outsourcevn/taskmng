...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(RecyclerViewHolder viewHolder, final int position) {
        ...
        int timeStartToCurrent, timeCurrentToEnd, timeStatToEnd, timeLine;

        if (taskType.equals(Constant.TODO)) {
            Todo todo = (Todo) list.get(position);
            Utility.setBackgoundPriority(viewHolder.imvPriority, todo.getPriority());
            ...
            timeLine = 0;
            String l = String.valueOf(Math.abs(timeStartToCurrent));
            viewHolder.txtTask.setText(String.valueOf(Math.abs(timeStartToCurrent)) + "d");
            viewHolder.txtTask.setTextColor(context.getResources().getColor(R.color.colorPrimaryDark));
            ...
            Utility.setBackgoundPriority(viewHolder.imvPriority, doing.getPriority());
            ...
            viewHolder.txtTask.setText(String.valueOf(timeCurrentToEnd) + "d");
            ...
            if (doing.getComper().equals("100") || timeCurrentToEnd <= 0) {
            ...
            Utility.setBackgoundPriority(viewHolder.imvPriority, done.getPriority());
            ...
            viewHolder.txtTask.setText(String.valueOf(timeCurrentToEnd) + "d");
            viewHolder.txtTask.setTextColor(context.getResources().getColor(R.color.damson));
